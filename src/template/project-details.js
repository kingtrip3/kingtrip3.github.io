...
import { FiList, FiUser, FiGithub } from "react-icons/fi";
                                        ...
                                        <div className="col-lg-12 col-md-12 col-12">
                                            <div className="content-left">
                                                ...
                                                <ul className="list_holder">
                                                    ...
                                                    <li><span className="icon"><FiGithub />Github Repo:</span><span className="projectinfo">{projectData.imgesBY}</span></li>
                                                </ul>
