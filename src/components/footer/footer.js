...
import { FaFacebookF, FaLinkedinIn, FaTwitter, FaInstagram, FaSkype, FaVimeo, FaGithub } from "react-icons/fa";
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--30 mt_sm--30 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="0.1s">
                            <div className="ft-info">
                                <p>Matthew Mukherjee <br />PORTFOLIO 2021</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--30 mt_sm--30 wow fadeInDown" data-wow-delay="200ms" data-wow-duration="0.6s">
                            <div className="ft-info">
                                <ul className="social-share">
                                    ...
                                    <li><a href="https://twitter.com/KingtripTO"><FaTwitter /></a></li>
                                    <li><a href="https://www.instagram.com/kingtrip3/"><FaInstagram /></a></li>
